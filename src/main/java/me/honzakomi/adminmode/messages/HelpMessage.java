...
public class HelpMessage {
    public static final String[] contentsWithReload = {
            "§6§l-- AdminMode Plugin Help --",
            "§6/AdminMode help§r: Show this help message.",
            "§6/AdminMode reload§r: Reload the config file.",
            "§6/AdminMode enable§r: Enable admin mode for you.",
